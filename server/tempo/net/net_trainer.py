...
def _iterate_batch(inputs, targets, batch_size, shuffle = False):
    ...
    #last_subset = i + batch_size
    #if last_subset < n:
    #    yield inputs[last_subset:], targets[last_subset:]
...
class NeuralNetTrainer(object):
    ...
    def train(self, train_inputs, train_targets, 
        ...
        #loss = lasagne.objectives.squared_error(prediction, targets_var).mean()
        ...
        updates = lasagne.updates.nesterov_momentum(
            ...
            momentum = momentum
        ) if method == 'momentum' else lasagne.updates.adadelta(
            loss,
            params,
            learning_rate = 1.0,
            rho = 0.95,
        ...
        #test_loss = lasagne.objectives.squared_error(test_prediction, targets_var).mean()
